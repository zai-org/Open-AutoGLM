...
class ActionHandlerIOS:
    """
    Handles execution of actions from AI model output on iOS devices.

    Args:
        device_id: WDA URL for iOS device.
    ...
    def _convert_relative_to_absolute(
        ...
        AutoGLM uses a normalized coordinate system from 0-999.
        We need to convert to actual pixel coordinates.
        """
    ...
    def _handle_back(self, action: dict, width: int, height: int) -> ActionResult:
        """Handle back action (iOS edge swipe)."""
        back(self.device_id)
        return ActionResult(True, False)
